...
var BaseStore = (function (_EventEmitter) {
  ...
  _createClass(BaseStore, [{
    ...
    value: function __parseResult(data, table) {
      ...
      var update_expire = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
      ...
      if (data.length < __collection.count() && !merge) {
        __col = _immutable2.default.Map();
        __di = _immutable2.default.Map();
      }
      ...
      data.forEach(function (elt) {
        ...
        //case 2: the record is already indexed in dict
            ...
            if (__check_same_record) {
              ...
              if (!_immutable2.default.is(r, __col.get(__cid))) {
                _4col.push(r);
              }
            } else {
    ...
    value: function __add(r) {
      ...
      if (!r.get("__cid")) {
        var _ret = (function () {
          var table = _this4.__getCurrentTable();
