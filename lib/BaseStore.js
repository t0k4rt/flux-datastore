...
var BaseStore = (function (_EventEmitter) {
  ...
  _createClass(BaseStore, [{
    ...
    value: function __parseCollection(data) {
      ...
      var j = 0;
      var collection = _immutable2.default.Map();
      var dict = _immutable2.default.Map();

      data.forEach(function (elt) {
        var r = _this2.record.fromJS(elt);
        r = r.set("__cid", "c" + j);
    ...
    key: "__parseCollectionBis",
    value: function __parseCollectionBis(data) {
      var _this3 = this;

      data.forEach(function (elt) {
        var record = _this3.__parseModel(elt);
        _this3.__add(record);
      });
    }
  }, {
