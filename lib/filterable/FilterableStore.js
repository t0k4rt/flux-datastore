...
var FilterableStore = exports.FilterableStore = function FilterableStore(ComposedStore) {
  return (function (_ComposedStore) {
    ...
    function _class(record, constants, __dispatcher, sync) {
      ...
      _this.filter = (0, _lodash2.default)(function (_ref) {
        var criterion = _ref.criterion;
        var keys = _ref.keys;

        this.__filter({ criterion: criterion, keys: keys });
    ...
    _createClass(_class, [{
      ...
      key: "old_filter",
      value: function old_filter(_ref3) {
        var criterion = _ref3.criterion;
        var keys = _ref3.keys;
