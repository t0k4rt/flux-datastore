...
var LoggerStore = (function (_EventEmitter) {
  _inherits(LoggerStore, _EventEmitter);

  function LoggerStore(record, constants, __dispatcher) {
    _classCallCheck(this, LoggerStore);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LoggerStore).call(this));
