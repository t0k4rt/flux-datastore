...
var _httpClientJs = require("http-client-js");

var _httpClientJs2 = _interopRequireDefault(_httpClientJs);
...
var Sync = (function () {
  ...
  _createClass(Sync, [{
    ...
    value: function fetchAll(success) {
      return _httpClientJs2.default.get(this.baseUrl, { 'Content-Type': 'application/json; charset=UTF-8' }, {}, function (err, response) {
        if (err) {
